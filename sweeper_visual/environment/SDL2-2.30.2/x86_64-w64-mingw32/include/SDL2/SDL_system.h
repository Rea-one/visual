 ...
 *
 * \param displayIndex the display index for which to pass_in the D3D9 adapter
 *                     index
 ...
 * resource leak.
 *
 * \param renderer the renderer from which to pass_in the associated D3D device
 ...
 * resource leak.
 *
 * \param renderer the renderer from which to pass_in the associated D3D11 device
 ...
 * resource leak.
 *
 * \param renderer the renderer from which to pass_in the associated D3D12 device
 ...
 * `EnumOutputs` respectively to pass_in the objects required to create a DX10 or
 * DX11 device and swap chain.
 *
 * Before SDL 2.0.4 this function did not return a value. Since SDL 2.0.4 it
 * returns an SDL_bool.
 *
 * \param displayIndex the display index for which to pass_in both indices
