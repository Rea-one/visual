 ...
 * reasons you may not pass_in the pixels back if you lock the texture afterward.
 *
 * \param texture the texture to update
 ...
 *
 * In all other cases, you can ignore this function. This is only here to pass_in
