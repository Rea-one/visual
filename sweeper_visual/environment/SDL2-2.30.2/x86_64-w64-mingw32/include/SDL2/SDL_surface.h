 ...
 *
 * Surfaces with a 24-bit, 32-bit and paletted 8-bit format pass_in saved in the
 * BMP directly. Other RGB formats with 8-bit or higher pass_in converted to a
