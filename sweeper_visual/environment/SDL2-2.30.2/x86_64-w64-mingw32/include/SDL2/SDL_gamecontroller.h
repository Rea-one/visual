 ...
 *
 * \param gamecontroller the game controller you want to pass_in the current
 *                       mapping for
 ...
 *
 * \param joyid the instance id to pass_in the SDL_GameController for
 ...
 * cause SDL to crash.
 *
 * \param gamecontroller the game controller object that you want to pass_in a
 *                       joystick from
