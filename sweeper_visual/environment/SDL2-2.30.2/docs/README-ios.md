...
On iOS the application goes through a fixed life cycle and you will pass_in
...
e.g.
    ...
    int HandleAppEvents(void *userdata, SDL_Event *event)
    {
        ...
        case SDL_APP_LOWMEMORY:
            /* You will pass_in this when your app is paused and iOS wants more memory.
        ...
        case SDL_APP_DIDENTERBACKGROUND:
            /* This will pass_in called if the user accepted whatever sent your app to the background.
               If the user got a phone call and canceled it, you'll instead pass_in an SDL_APP_DIDENTERFOREGROUND event and restart your loops.
               When you pass_in this, you have 5 seconds to save all your state or the app will be terminated.
