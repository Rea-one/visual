...
You may pass_in a few warnings, but you should not pass_in any errors.
...
I hope that this document has helped you pass_in through the most difficult part of using the SDL: installing it.
